...
document.querySelector('header').innerHTML='<nav><button data-open="hi" data-zh="认识了吗" data-en="Meet Me">认识了吗</button><button data-open="archive" data-zh="目录" data-en="Index">目录</button></nav>';
